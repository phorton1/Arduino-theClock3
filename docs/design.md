...
For ease of design all gears are **separated by 120mm** center-to-center.
...
gear takes 8/9ths of the distance between them.  So the min1b gear has a diameter of 8/9 * 120mm or
approximately **106.667 mm**.   *Dividing the diameter by the number of teeth results
in the modulus*.  So 106.667 / 64 equals approximately **1.667** for the calculated
modulus of the 1st gear pair which we then plug into Fusion to generate the drawing
of the min1b gear.
